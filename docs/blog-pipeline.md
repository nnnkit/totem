...
flow. Lives next to `docs/seo-blog-research.md` (the original keyword research)
...
[`docs/seo-agent-goal.md`](seo-agent-goal.md). It turns this pipeline and the
