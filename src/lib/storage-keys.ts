...
export const LS_FULL_EXPORT_READY_DISMISSED = "totem_full_export_ready_dismissed";
...
export const LOCAL_STORAGE_KEYS = [
  ...
  LS_READER_ACTIVITY,
  LS_RECENT_SEARCHES,
  LS_FULL_EXPORT_READY_DISMISSED,
...
export const CS_GROWTH_STATE = "totem_growth_state";
