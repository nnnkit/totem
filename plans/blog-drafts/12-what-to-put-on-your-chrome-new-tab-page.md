---
title: "What to Put on Your Chrome New Tab Page"
slug: what-to-put-on-your-chrome-new-tab-page
description: "A practical way to decide what belongs on your Chrome new tab page: blank page, launcher, dashboard, or reading queue."
publishedAt: 2026-06-10
draft: false
canonicalKeyword: chrome new tab page
---
...
- The SERP answers "how do I customize it?" Google Help, Chrome Web Store pages, Reddit threads, and SuperUser all cluster around settings, extensions, and broken customization.
- The missing question is "what belongs there?"
- Chrome's native page already offers shortcuts, most visited sites, themes, cards, resume browsing, tabs from other devices, and in some managed-device cases Drive priority cards.
- Extensions can replace the new tab page, but Chrome's own developer docs say the page should be quick and small because users expect browser pages to open instantly.
- A new tab is not a homepage. A homepage is where the browser starts. A new tab is a small decision point between actions.
- The right surface depends on the next job: focus, launch, resume, read.
- Totem fits only one branch: saved X posts as a reading queue.
- Do not claim everyone opens new tabs 50 times a day unless sourced. Use "all day" and "constantly" instead.
- Do not make this a listicle. L4 can become the tool roundup later.

## Beat Map

1. Open by reframing the question: the Chrome new tab page is a choice point, not decoration.
2. Quick factual baseline: what Chrome lets you customize natively.
3. Explain that changing the page is easy; choosing the job is hard.
4. Four useful options: blank, launcher, dashboard/resume, reading queue.
5. Call out weak choices: news feeds, giant todo boards, feeds that create delay.
6. Connect to Chrome Reading List and bookmark managers: hidden lists fail when the return surface is weak.
7. Totem appears late as the X bookmarks branch.
8. End with a small test: what did the last ten new tabs need to do?
...
Google's help page says you can choose shortcuts or most-visited sites, change the background and browser color, manage dark mode, turn cards on or off, resume browsing from history, continue with tabs from other devices, and show or hide the footer that indicates which extension controls the page.[^chrome-help]
...
You can get close with Chrome's native controls by hiding shortcuts and cards. If you want a true blank page, Chrome Web Store tools such as New Tab Redirect and Custom New Tab exist mostly to point new tabs at a custom URL, local file, or `about:blank`.[^new-tab-redirect][^custom-new-tab]

Chrome extensions can also replace the new tab page directly. Chrome's developer docs call this an override page and say new tab overrides should be quick and small because users expect built-in browser pages to open instantly.[^chrome-override]
...
Google's own new tab cards point in the sensible direction: resume browsing, related history, and recent tabs from other devices.[^chrome-help] Those are not decorative. They help you continue a real browsing thread.
...
If you are still choosing between X bookmark tools, start with the broader [Twitter bookmark manager comparison](/blog/best-twitter-bookmark-managers-2026). This page is only about whether the new tab is the right surface.
...
[^chrome-help]: Google Chrome Help, ["Customize your New Tab page in Chrome - Computer"](https://support.google.com/chrome/answer/11032183?co=GENIE.Platform%3DDesktop&hl=en).
