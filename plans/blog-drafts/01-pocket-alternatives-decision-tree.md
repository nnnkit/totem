---
title: "Pocket Alternatives for 2026: A Decision Tree (and Why None of Them Are Built for Twitter)"
slug: pocket-alternatives-2026
description: "Mozilla shut down Pocket. Most alternative listicles miss the part where most people's read-later list is mostly Twitter threads. Here's a decision tree, and an honest comparison."
publish_target: 2026-W18
canonical_keyword: pocket alternative
---

# Pocket Alternatives for 2026: A Decision Tree

Mozilla announced Pocket's shutdown on **May 22, 2025**. The service went dark on **July 8, 2025**. As of **November 12, 2025**, exports were disabled and all user data was queued for permanent deletion.[^moz-support] Annual subscribers got prorated refunds.[^verge]

Mozilla's own framing of why:
...
That last sentence is the one to chew on. Yes — *the way people save content has evolved.* Mostly: a lot of it is now Twitter/X threads. None of the popular Pocket alternatives are built for that. This post is a decision tree, an honest comparison table, and a small detour into the read-later tool nobody tells you about because it only does one thing well.

## Where this post is going

There is no single "best Pocket alternative." There is the alternative that fits **the kind of stuff you save** and **the place you want it to live**. Skip ahead if you want:

- [The decision tree](#decision-tree)
- [Honest comparison table](#comparison-table)
- ["Most of what I save is Twitter threads"](#twitter-graveyard)
- [What we picked, and why it's narrow on purpose](#totem)

## A quick read on the room

The day Mozilla announced the shutdown, the Hacker News thread filled up with users explaining why they had already left Pocket *before* it shut down. The reasons were the same as the reasons Pocket itself cited:
...
> — bayindirh, [HN thread](https://news.ycombinator.com/item?id=44063662)
...
> — gxqoz, [HN thread](https://news.ycombinator.com/item?id=44063662)

> "I finally gave up on it last year, mostly due to frustration with the terrible 2023 redesign of the mobile app."
> — segphault, [HN thread](https://news.ycombinator.com/item?id=44063662)
...
That is the real read-later problem. It's not a tooling problem; it's a behavioral one. Anything you choose has to make you actually look at the thing you saved, not just collect more of them.
...
Read on. This branch is the one almost no listicle covers, and it's probably you.

<a id="twitter-graveyard"></a>
## The branch nobody covers: most of what you save is Twitter

If you bookmark on X regularly, your read-later list is *already* mostly Twitter threads. The Medium piece that floats around when this comes up calls it a graveyard:
...
We made [Totem](https://totem.app) — a Chrome extension that replaces your new tab with the X/Twitter bookmarks you actually meant to read. It's free, has no login, no server, and stores everything in your browser's local IndexedDB.
...
The reason we lean into the narrow scope: the post-Pocket era is full of cloud-hosted tools that promise to be everything to everyone, and a chunk of them disappear (Pocket, Omnivore, eventually others). Local-first means there's no server we can shut off. And new tab placement means the *behavioral* problem — saving more than you read — gets a daily nudge instead of a "remember to open this app" expectation.
...
3. **If a third or more of what you save is from X**, install [Totem](https://totem.app) alongside whatever long-form tool you pick. They don't conflict — they cover different surface area.
